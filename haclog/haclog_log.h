...
enum {
	HACLOG_LOG_LEVEL_OFFSET = 8,
	HACLOG_LOG_LEVEL_TRACE = 0,
	HACLOG_LOG_LEVEL_DEBUG = 1 << HACLOG_LOG_LEVEL_OFFSET,
	HACLOG_LOG_LEVEL_INFO = 2 << HACLOG_LOG_LEVEL_OFFSET,
	HACLOG_LOG_LEVEL_WARNING = 3 << HACLOG_LOG_LEVEL_OFFSET,
	HACLOG_LOG_LEVEL_WARN = HACLOG_LOG_LEVEL_WARNING,
	HACLOG_LOG_LEVEL_ERROR = 4 << HACLOG_LOG_LEVEL_OFFSET,
	HACLOG_LOG_LEVEL_FATAL = 5 << HACLOG_LOG_LEVEL_OFFSET,
	HACLOG_LOG_LEVEL_MAX = 6,
};

#define HACLOG_TRACE(format, ...) \
	HACLOG_LOG_DEFAULT(HACLOG_LOG_LEVEL_TRACE, format, ##__VA_ARGS__)
#define HACLOG_DEBUG(format, ...) \
	HACLOG_LOG_DEFAULT(HACLOG_LOG_LEVEL_DEBUG, format, ##__VA_ARGS__)
#define HACLOG_INFO(format, ...) \
	HACLOG_LOG_DEFAULT(HACLOG_LOG_LEVEL_INFO, format, ##__VA_ARGS__)
#define HACLOG_WARNING(format, ...) \
	HACLOG_LOG_DEFAULT(HACLOG_LOG_LEVEL_WARNING, format, ##__VA_ARGS__)
#define HACLOG_ERROR(format, ...) \
	HACLOG_LOG_DEFAULT(HACLOG_LOG_LEVEL_ERROR, format, ##__VA_ARGS__)
#define HACLOG_FATAL(format, ...) \
	HACLOG_LOG_DEFAULT(HACLOG_LOG_LEVEL_FATAL, format, ##__VA_ARGS__)
	...
	#define LOG_LEVEL_TRACE HACLOG_LOG_LEVEL_TRACE
	#define LOG_LEVEL_DEBUG HACLOG_LOG_LEVEL_DEBUG
	#define LOG_LEVEL_INFO HACLOG_LOG_LEVEL_INFO
	#define LOG_LEVEL_WARNING HACLOG_LOG_LEVEL_WARNING
	#define LOG_LEVEL_ERROR HACLOG_LOG_LEVEL_ERROR
	#define LOG_LEVEL_FATAL HACLOG_LOG_LEVEL_FATAL
