...
| date | version |
| ---- | ---- |
| 2026-09-08 | [v0.4.5](#v045) |
| 2026-06-26 | [v0.4.4](#v044) |
...
---
## v0.4.5
* fix `haclog_thread_detach` in MSVC, avoid thread handle leaks

---
## v0.4.4
* fix `haclog_file_time_rot_handler_t::use_local_time` was not set in time during init phase
